...
const EntradaPronostico = ( { resultado } ) => {
  ...
  const { nombre, categoria, img, sorteo, valorTicket } = resultado
              ...
              <div className='col-12 col-md-5'>
                <div className='bg-white shadow-sm p-3 rounded'>
                    ...
                    >
                      ...
                      <div className="mb-3">
                        <label htmlFor='sorteo' className="form-label fw-bold">Elige el sorteo en el que deseas participar</label>
                        <select
